                        ...
                        <div class="nav-item dropdown">
                            ...
                            <?php else: ?>
                                ...
                                <div class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu rounded-0 m-0 active" aria-labelledby="userDropdown">
            ...
            <div class="bg-white rounded p-4" style="border: 1px dashed rgba(0, 185, 142, .3)">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-12 wow fadeIn" data-wow-delay="0.5s">
                        <div class="mb-4">
                            <h4>No Property Under Purchase</h4>
                            <p>You currently have no properties under purchase. 
                                Please ensure a property is in the purchase process before proceeding with payment.</p>
                        </div>
                        <a href="property-list.php" class="btn btn-primary py-3 px-4 me-2"><i class="fa fa-calendar-alt me-2"></i>Survey Propeties</a>
