            ...
            <div class="card card-default">
              ...
              <div class="card-body" >
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="email" class="form-control" id="prop-location" placeholder="Enter property address">
                    </div>
                    <!-- /.form-group -->
                  </div>
                  <!-- /.col -->
                ...
                <div class="form-floating">
                  ...
                  <textarea class="form-control" placeholder="Property Description" id="description"></textarea>
                </div>
                <br>
                <div class="col-12 tab-loading">
                    <button class="btn btn-primary w-100" id="submit_event">
...
<script>
  $("#submit_event").click(() => {
    ...
    formdata.append('prop_location',$("#prop-location").val());
    formdata.append('prop_type',$("#prop-type").val());
    formdata.append('transactionType',$("#transaction-type").val());
